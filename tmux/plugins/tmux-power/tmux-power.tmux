...
LS="#[fg=$G04,bg=$TC,bold] $session_icon #S #[fg=$TC,bg=$G04,nobold]$right_arrow_icon"
if "$show_upload_speed"; then
	LS="$LS#[fg=$G04,bg=$G04]$right_arrow_icon#[fg=$TC,bg=$G05] $upload_speed_icon#{upload_speed} #[fg=$G05,bg=$BG]$right_arrow_icon"
#else
...
prefix_hint="#{?client_prefix,#[fg=$G06]#[bg=$BG]$left_arrow_icon#[fg=$TC]#[bg=$G06] D #[fg=$TC]#[bg=$G06]$left_arrow_icon,#[fg=$TC]#[bg=$BG]$left_arrow_icon}"
tmux_set status-right-bg "$G04"
tmux_set status-right-fg "G12"
tmux_set status-right-length 160
RS="#[fg=$G04,bg=$TC] #(~/.myjiaoben/get_current_shurufa_for_tmux) #[fg=$G06,bg=$TC]$left_arrow_icon#[fg=$TC,bg=$G06] %T #[fg=$TC,bg=$G06]$left_arrow_icon#[fg=$G04,bg=$TC] %m-%d "
